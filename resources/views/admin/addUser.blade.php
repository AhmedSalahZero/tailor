...
@section('content')
    ...
    <div class="card-body">
        ...
        <div class="form-group">
            ...
            <select name="shippingMethod" class="custom-select">
                <option value="1">none</option>
                <option value="2" SELECTED>aramex</option>
            </select>
        </div>
        <button type="submit" id="sub_form_add" class="btn btn-primary mt-4 pr-4 pl-4" style="margin-left: 40%">Submit</button>
    </div>
...
@section('footer')
    <script>
        ...
        $(document).on('click', '#sub_form_add', function (e) {
            e.preventDefault();
            $.ajax({
                type: 'POST',
